...
$(document).ready(function () {
  ...
  /**
   * Set meta theme-color according to page background.
   */
  document.querySelector("meta[name=theme-color]").setAttribute("content", window.getComputedStyle(document.body, null).getPropertyValue('color'));
